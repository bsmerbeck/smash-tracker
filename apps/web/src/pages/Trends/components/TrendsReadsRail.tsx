 ...
 * `RatingMove`, `TiltCost`, `SessionFatigue`. Resolved once at module scope:
 * the registry is a static, closed array.
 */
...
const RAIL_TEMPLATES = [RATING_MOVE_TEMPLATE, TILT_COST_TEMPLATE, SESSION_FATIGUE_TEMPLATE];
